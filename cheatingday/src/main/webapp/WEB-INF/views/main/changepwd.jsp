         ...
         <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
            <form class="login100-form validate-form flex-sb flex-w" id="u_change_pwd_form" method="post">
               ...
               <div>
                  ...
                  <button type="button" class="btn btn-danger" id="uChangePwd" style="margin-top: 50px;">비밀번호 변경</button>
               </div>
            </form>
         </div>
      </div>
      ...
      <div class="container-login100">
         <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
            <form class="login100-form validate-form flex-sb flex-w" id="m_change_pwd_form" method="post">
               ...
               <div>
                  <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                  <button type="button" class="btn btn-danger" id="mChangePwd" style="margin-top: 50px;">비밀번호 변경</button>
               </div>
            </form>
         </div>
      </div>
